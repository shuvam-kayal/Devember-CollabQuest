...
import {
  ...
  CheckCircle, Send, Code2, Mail, Clock, XCircle, RotateCcw, Check,
  Calendar, Award, Star,
  ChevronLeft, ChevronRight, LayoutDashboard, Users, Settings
} from "lucide-react";
              ...
              <GlassCard className="p-8 h-full flex flex-col justify-center items-start relative overflow-hidden">
                ...
                <div className="relative z-10 w-full">
                  <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
                    Build Your Dream Team <span className="text-yellow-400">✨</span>
                  </h2>
              ...
              <div className="xl:col-span-2 w-full space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-bold flex items-center gap-2 text-white mb-4">
                    <div className="p-1.5 bg-blue-500/20 rounded-lg"><Award className="w-4 h-4 text-blue-400" /></div>
                    News from CollabQuest
                  </h3>
